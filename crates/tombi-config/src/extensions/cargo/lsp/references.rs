...
pub enum CargoReferencesFeatures {
    Enabled(EnabledOnly),
    Features(CargoReferencesFeatureTree),
    Combined(CargoReferencesCombinedFeatureTree),
}
...
pub struct CargoReferencesFeatureTree {
...
pub struct CargoReferencesCombinedFeatureTree {
    /// # Enable references feature
    ///
    /// Whether to enable all Cargo references features.
...
impl Default for CargoReferencesFeatures {
    fn default() -> Self {
        Self::Features(CargoReferencesFeatureTree::default())
    }
}

impl CargoReferencesFeatures {
