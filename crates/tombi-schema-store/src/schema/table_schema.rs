...
use crate::{
    schema::table_order_schema::TableKeysOrderSchema, Accessor, Referable, SchemaProperties,
    SchemaStore,
};
...
pub struct TableSchema {
    ...
    pub keys_order: Option<TableKeysOrderSchema>,
...
impl TableSchema {
    pub fn new(
        ...
        let keys_order = object_node
            ...
            .and_then(TableKeysOrderSchema::new);
