...
However, Tombi only allows document comment directives at the beginning of the document, so you need to add a blank line between the value and the directive.
