import { Note, Tip } from "~/components/Highlight";

# Tombi Value Directive

`# tombi:` value comment directives are comments that apply to a specific value.
...
- [lint](#lint-rules)
  - [lint.rules](#lint-rules)
    ...
    - [lint.rules.enum](#lint-rules-enum)
      - [lint.rules.enum.disabled](#lint-rules-enum-disabled)
