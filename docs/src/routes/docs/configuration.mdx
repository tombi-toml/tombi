...
- [format](#format)
  - [format.rules](#format-rules)
    ...
    - [format.rules.indent-table-key-values](#format-rules-indent-table-key-values)
    ...
    - [format.rules.key-value-equal-alignment](#format-rules-key-value-equal-alignment)
    - [format.rules.key-value-equal-space-width](#format-rules-key-value-equal-space-width)
    - [format.rules.line-ending](#format-rules-line-ending)
    - [format.rules.line-width](#format-rules-line-width)
    - [format.rules.quote-style](#format-rules-quote-style)
