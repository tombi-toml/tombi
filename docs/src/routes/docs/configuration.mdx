...
- `tombi-toml/cargo`: Cargo-specific completion, navigation, document links, and code actions for `Cargo.toml`
- `tombi-toml/pyproject`: `pyproject.toml`-specific completion, navigation, document links, and code actions
- `tombi-toml/tombi`: Tombi's own config-oriented path completion, navigation, and document links
