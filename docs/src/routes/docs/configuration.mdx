...
It also supports `[tool.tombi]` in `pyproject.toml`.
...
- [lsp](#lsp)
  ...
  - [lsp.references](#lsp-references)
    - [lsp.references.enabled](#lsp-references-enabled)
...
- [extensions](#extensions)
  - [extensions."tombi-toml/cargo"](#extensions-tombi-toml-cargo)
    - [extensions."tombi-toml/cargo".lsp](#extensions-tombi-toml-cargo-lsp)
      ...
      - [extensions."tombi-toml/cargo".lsp.code-action.update-dependency-to-latest-version](#extensions-tombi-toml-cargo-lsp-code-action-update-dependency-to-latest-version)
      ...
      - [extensions."tombi-toml/cargo".lsp.references](#extensions-tombi-toml-cargo-lsp-references)
  - [extensions."tombi-toml/pyproject"](#extensions-tombi-toml-pyproject)
    - [extensions."tombi-toml/pyproject".lsp](#extensions-tombi-toml-pyproject-lsp)
      ...
      - [extensions."tombi-toml/pyproject".lsp.code-action.update-dependency-to-latest-version](#extensions-tombi-toml-pyproject-lsp-code-action-update-dependency-to-latest-version)
      ...
      - [extensions."tombi-toml/pyproject".lsp.references](#extensions-tombi-toml-pyproject-lsp-references)
...
Configure references feature.

### lsp.references.enabled

Enable or disable references feature.
...
- `exclude`(optional): File match patterns to skip even if `include` matched
...
- `root`: The accessor path to apply the sub-schema (e.g., `"tools.tombi"`, `"tool.*"`, `"tool.'*'"`, `"items[1].name"`). Use bare `*` for any key segment, `[*]` for any array element, and numeric indices such as `[1]` for a specific tuple element. If you need the literal key `*`, quote it as `'*'` or `"*"`.
- `path`: The schema path (URL or local file path)
- `include`: File match patterns to apply this schema (supports glob patterns)
- `exclude`(optional): File match patterns to skip even if `include` matched
- `lint.rules.deprecated`(optional): Override the deprecated diagnostic level for this schema with `"off"`, `"warn"`, or `"error"`
...
Use `""` to target the root table. Use `*` for any key segment, `[*]` for any array element, and numeric indices such as `[1]` for a specific tuple element.
...
### extensions."tombi-toml/cargo".lsp.references

Configure Cargo-specific references features.

See [Cargo Extension > References](/docs/extensions/tombi-extension-cargo#references).

- Type: `Table`

### extensions."tombi-toml/cargo".lsp.references.enabled

Enable or disable all Cargo references features.

- Type: `Boolean`
- Default: `true`

### extensions."tombi-toml/cargo".lsp.references.dependency

Configure references for Cargo dependencies.
This lists dependency-related usages such as feature activations and workspace dependency consumers.

See [Cargo Extension > References](/docs/extensions/tombi-extension-cargo#references).

- Type: `Table`

### extensions."tombi-toml/cargo".lsp.references.dependency.enabled

Enable or disable references for Cargo dependencies.
...
### extensions."tombi-toml/cargo".lsp.code-action.update-dependency-to-latest-version

Configure the "Update Dependency to Latest Version" code action for Cargo manifests.
This refactor rewrites dependency versions to the latest published version.

See [Cargo Extension > Code Actions](/docs/extensions/tombi-extension-cargo#code-actions).

- Type: `Table`

### extensions."tombi-toml/cargo".lsp.code-action.update-dependency-to-latest-version.enabled

Enable or disable the "Update Dependency to Latest Version" code action for Cargo manifests.
...
### extensions."tombi-toml/pyproject".lsp.references

Configure `pyproject.toml`-specific references features.

See [Pyproject Extension > References](/docs/extensions/tombi-extension-pyproject#references).

- Type: `Table`

### extensions."tombi-toml/pyproject".lsp.references.enabled

Enable or disable all `pyproject.toml` references features.

- Type: `Boolean`
- Default: `true`

### extensions."tombi-toml/pyproject".lsp.references.dependency

Configure references for `pyproject.toml` dependencies.
This lists workspace-backed dependency usages and related include-group consumers.

See [Pyproject Extension > References](/docs/extensions/tombi-extension-pyproject#references).

- Type: `Table`

### extensions."tombi-toml/pyproject".lsp.references.dependency.enabled

Enable or disable references for `pyproject.toml` dependencies.
...
### extensions."tombi-toml/pyproject".lsp.code-action.update-dependency-to-latest-version

Configure the "Update Dependency to Latest Version" code action for `pyproject.toml`.
This refactor rewrites dependency versions to the latest published version.
...
### extensions."tombi-toml/pyproject".lsp.code-action.update-dependency-to-latest-version.enabled

Enable or disable the "Update Dependency to Latest Version" code action for `pyproject.toml`.
