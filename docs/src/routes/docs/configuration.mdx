...
2. `tombi.toml` in the current directory
3. `[tool.tombi]` in `pyproject.toml` in the current directory
4. ...search parent directory recursively
...
- [extensions](#extensions)
  - [extensions."tombi-toml/cargo"](#extensions-tombi-tomlcargo)
    - [extensions."tombi-toml/cargo".lsp](#extensions-tombi-tomlcargo-lsp)
      - [extensions."tombi-toml/cargo".lsp.completion](#extensions-tombi-tomlcargo-lsp-completion)
      - [extensions."tombi-toml/cargo".lsp.goto-definition](#extensions-tombi-tomlcargo-lsp-goto-definition)
      - [extensions."tombi-toml/cargo".lsp.goto-declaration](#extensions-tombi-tomlcargo-lsp-goto-declaration)
      - [extensions."tombi-toml/cargo".lsp.document-link](#extensions-tombi-tomlcargo-lsp-document-link)
      - [extensions."tombi-toml/cargo".lsp.code-action](#extensions-tombi-tomlcargo-lsp-code-action)
      - [extensions."tombi-toml/cargo".lsp.hover](#extensions-tombi-tomlcargo-lsp-hover)
      - [extensions."tombi-toml/cargo".lsp.inlay-hint](#extensions-tombi-tomlcargo-lsp-inlay-hint)
  - [extensions."tombi-toml/pyproject"](#extensions-tombi-tomlpyproject)
    - [extensions."tombi-toml/pyproject".lsp](#extensions-tombi-tomlpyproject-lsp)
      - [extensions."tombi-toml/pyproject".lsp.completion](#extensions-tombi-tomlpyproject-lsp-completion)
      - [extensions."tombi-toml/pyproject".lsp.goto-definition](#extensions-tombi-tomlpyproject-lsp-goto-definition)
      - [extensions."tombi-toml/pyproject".lsp.goto-declaration](#extensions-tombi-tomlpyproject-lsp-goto-declaration)
      - [extensions."tombi-toml/pyproject".lsp.document-link](#extensions-tombi-tomlpyproject-lsp-document-link)
      - [extensions."tombi-toml/pyproject".lsp.code-action](#extensions-tombi-tomlpyproject-lsp-code-action)
      - [extensions."tombi-toml/pyproject".lsp.hover](#extensions-tombi-tomlpyproject-lsp-hover)
      - [extensions."tombi-toml/pyproject".lsp.inlay-hint](#extensions-tombi-tomlpyproject-lsp-inlay-hint)
  - [extensions."tombi-toml/tombi"](#extensions-tombi-tomltombi)
    - [extensions."tombi-toml/tombi".lsp](#extensions-tombi-tomltombi-lsp)
      - [extensions."tombi-toml/tombi".lsp.completion](#extensions-tombi-tomltombi-lsp-completion)
      - [extensions."tombi-toml/tombi".lsp.goto-definition](#extensions-tombi-tomltombi-lsp-goto-definition)
      - [extensions."tombi-toml/tombi".lsp.document-link](#extensions-tombi-tomltombi-lsp-document-link)
      - [extensions."tombi-toml/tombi".lsp.hover](#extensions-tombi-tomltombi-lsp-hover)
...
Configure workspace-value inlay hints for Cargo package inheritance.
...
Enable or disable workspace-value inlay hints for Cargo package inheritance.
