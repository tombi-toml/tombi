...
Use this when a dependency string is already present and you want Tombi to rewrite the pinned requirement without changing the surrounding dependency group structure.
