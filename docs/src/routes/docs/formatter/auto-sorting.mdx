...
Completely disabling automatic sorting means you will have to bear significant maintenance costs.
...
You can specify auto-sorting methods using [comment directives](/docs/comment-directive#format-rules).
...
When schemas automatically retrieved from the [JSON Schema Store](https://json.schemastore.org) contain the following keys, automatic sorting is performed according to that schema:
