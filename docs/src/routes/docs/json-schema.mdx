...
By specifying objects instead of strings, you can individually define sorting methods for the different groups: `properties`, `additionalProperties`, and `patternProperties`.
...
By specifying objects instead of strings, you can individually define sorting methods for the different groups: `oneOf`, `anyOf`.
