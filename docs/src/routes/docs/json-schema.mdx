...
By specifying objects instead of string, you can individually define sorting methods for the different groups: `properties`, `additionalProperties`, and `patternProperties`.
