...
### Validation Score
For complex JSON Schemas, many types of errors occur when they do not match the schema.
To identify the errors humans want to know, Tombi filters out unnecessary errors by scoring the schema's fit.
