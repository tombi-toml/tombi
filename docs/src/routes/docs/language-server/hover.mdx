...
For dependency entries, Tombi can also enrich hover content with package metadata such as the
resolved package name and description.
...
See also:
- [Cargo Extension](/docs/extensions/tombi-extension-cargo)
- [Pyproject Extension](/docs/extensions/tombi-extension-pyproject)
