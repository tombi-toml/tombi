...
## Cargo/pyproject Workspace Support

Tombi supports Cargo and `pyproject.toml` workspace navigation.
...
See more details: [tombi-extension-cargo](/docs/extensions/tombi-extension-cargo) / [tombi-extension-pyproject](/docs/extensions/tombi-extension-pyproject)
...
See more details: [Go to Type Definition](/docs/language-server/goto-definition#go-to-json-schema)
...
Tombi's formatting policy is to avoid deleting user data.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>[`key-value-equals-sign-alignment`](/docs/configuration#format-rules-key-value-equals-sign-alignment)</td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>[`key-value-equals-sign-space-width`](/docs/configuration#format-rules-key-value-equals-sign-space-width)</td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>[`indent-table-key-value-pairs`](/docs/configuration#format-rules-indent-table-key-value-pairs)</td>
      <td></td>
    </tr>
    <tr>
...
Taplo's [`[[rule]]`](https://taplo.tamasfe.dev/configuration/file.html#rules) corresponds to Tombi's [`[[overrides]]`](/docs/configuration#overrides).
...
but Tombi uses [schema-based auto sorting](/docs/formatter/auto-sorting) instead.
For applying schemas to specific key paths, use [`schemas[*].root`](/docs/configuration#sub-schema).
