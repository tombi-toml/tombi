...
Tombi provides rich support for comment directives, offering far more options compared to Taplo.
With Tombi, you can specify not just the TOML version and JSON Schema, but also enable or disable various linting rules and customize multiple behaviors within your TOML files, all through comments. This extensibility gives you precise control over file-specific behavior, exceeding the flexibility available in Taplo.
