...
Tombi supports comment directive.
This allows the user to specify the TOML version, JSON Schema, lint rules disabled, and other options for the TOML file.

See more details: [Comment Directive](/docs/language-server/comment-directive)
