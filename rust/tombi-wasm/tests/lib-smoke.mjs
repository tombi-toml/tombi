...
import init, { format, lint } from "../../tombi-wasm-lib/dist/tombi_wasm.js";

const wasm = await readFile(new URL("../../tombi-wasm-lib/dist/tombi_wasm_bg.wasm", import.meta.url));
